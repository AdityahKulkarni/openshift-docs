...
For user-provisioned infrastructure clusters, you can add 4 or 5 control plane nodes by using a {op-system} ISO image and connecting it to your cluster using cluster Ignition config files.
